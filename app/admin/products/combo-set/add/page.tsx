  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-800">💎 Add New Combo Set</h1>
          <p className="text-gray-600">Create a complete jewelry set with necklace, bengals, and earrings</p>
        </div>
      </div>
