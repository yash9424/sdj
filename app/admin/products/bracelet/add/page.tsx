    ...
    try {
      ...
      if (response.ok) {
        setNotification({
          show: true,
          type: 'success',
          message: 'Bengals added successfully!'
        })
        setTimeout(() => {
        ...
        setNotification({
          show: true,
          type: 'error',
          message: 'Failed to add bengals'
        })
      }
    } catch (error) {
      console.error('Error adding bracelet:', error)
      setNotification({
        show: true,
        type: 'error',
        message: 'Error adding bengals'
      })
    } finally {
      setLoading(false)
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-800">🔗 Add New Bengals</h1>
          <p className="text-gray-600">Create beautiful bengals and bracelets</p>
        </div>
      </div>
